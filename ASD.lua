...
OkayBtnTitle.BackgroundTransparency = 0
...
NotificationTitle.BackgroundTransparency = 0
...
NotificationDesc.BackgroundTransparency = 0
...
-- UIStroke.Archivable = true
			...
			UICorner_2.Parent = Button
				...
				imgLabelIcon.BackgroundTransparency = 0
...
return dropfunc
    ...
    function main:AddSlider(text, min, max, start, callback)
                ...
                SliderFrame.BackgroundColor3 = Color3.fromRGB(240, 240, 240)                SliderFrame.BackgroundTransparency = 0
...
Title.TextXAlignment = Enum.TextXAlignment.Left
                ...
                SliderButton.BackgroundColor3 = Color3.fromRGB(46, 56, 56)              SliderButton.BackgroundTransparency = 0
                ...
                SliderButton.InputEnded:Connect(function(input)
                    if input.UserInputType == Enum.UserInputType.MouseMovement or input.UserInputType == Enum.UserInputType.Touch then
                        ...
                        game.TweenService:Create(Title_2, TweenInfo.new(0.12, Enum.EasingStyle.Linear, Enum.EasingDirection.InOut), {AnchorPoint = Vector2.new(0, 0), TextSize = 8.000, BackgroundTransparency = 0, Size = UDim2.new(0, 18, 0, 18)}):Play()
...
TextboxLabel.BackgroundColor3 = Color3.fromRGB(1, 1, 1)TextboxLabel.BackgroundTransparency = 0
...
txtbtn.BackgroundTransparency = 0
...
txtbtn.Name = "txtbtn"
txtbtn.Parent = Textbox
txtbtn.BackgroundColor3 = Color3.fromRGB(1, 1, 1)txtbtn.BackgroundTransparency = 0
txtbtn.Position = UDim2.new(0, 1, 0, 1)
txtbtn.Size = UDim2.new(0, 379, 0, 29)
txtbtn.Font = Enum.Font.SourceSans
txtbtn.Text = ""
...
Labeld.BackgroundTransparency = 0
...
Linee.BackgroundTransparency = 0
